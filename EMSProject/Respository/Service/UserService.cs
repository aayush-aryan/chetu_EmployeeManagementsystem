    ...
    public class UserService:IUser
    {
        ...
        public SignUp Register(SignUp model)
        {
            ...
            else
            {
                ...
                //GenerateOTP() define and implemented in UserService
                string Otp = GenerateOTP();
                // SendMail(string to,string Otp) define and implemented in UserService 
        ...
        private  void SendMail(string to,string Otp)
        {
            ...
            mail.To.Add(to);
            mail.From = new MailAddress("log2aayusharyan@gmail.com");
            ...
            smtp.Credentials = new System.Net.NetworkCredential("log2aayusharyan@gmail.com", "8002239404"); // Enter seders User name and password  
            smtp.EnableSsl = true;
            smtp.Send(mail);
